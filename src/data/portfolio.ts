...
export const about = {
  description: [
    ...
    "UI/UX, 브랜딩, 그래픽 디자인을 아우르며, " +
      "사용자 경험과 시각적 완성도 모두를 중요하게 생각합니다.",
    "클라이언트와의 소통을 바탕으로 문제를 정의하고, " +
      "목적에 맞는 디자인 솔루션을 제안합니다.",
  ],
  highlights: [
    { label: "경력", value: "3+ years" },
    { label: "위치", value: "Seoul, Korea" },
    { label: "관심 분야", value: "UI/UX \xB7 Branding \xB7 Visual Design" },
  ],
};
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "문화 행사 시리즈 포스터 디자인. " +
      "타이포그래피와 일러스트를 활용한 시각적 통일감을 구현했습니다.",
